package com.recolba.workshopmongo.config;
...
import com.recolba.workshopmongo.domain.Post;
import com.recolba.workshopmongo.domain.User;
import com.recolba.workshopmongo.dto.AuthorDTO;
import com.recolba.workshopmongo.dto.CommentDTO;
import com.recolba.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		userRepository.saveAll(Arrays.asList(maria, alex, bob));userRepository.saveAll(Arrays.asList(maria, alex, bob));
